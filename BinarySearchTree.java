...
public class BinarySearchTree<T extends Comparable<T>> implements SortedCollectionInterface<T> {
    ...
    // draft 1 implemented 1/30, check again 1/31
    protected void rotate(Node<T> child, Node<T> parent) throws IllegalArgumentException {
        ...
        if(isLeftChild){
            ...
            //Update the left child of the parent to be the right child of the child
            parent.down[0] = child.down[1];

            //if the right child is not null, the right child's parent reference is set to parent
            // ensures parent-child relationship after rotation
            if(child.down[1] != null){
                child.down[1].up = parent;
            }
            //Update the right child of hte child to be the parent
            child.down[1] = parent;
        }
        else{
            //Left Rot
        ...
        //Set the parent of the child to be the grandparent
        ...
        // If there is no grandparent, update the root of the tree to be the child
        parent.up = child;
    }
    ...
    /**
     * This test method performs a right rotation and then checks if the tree is balanced
     * @return a boolean on whether the tree is balanced or not
     */
    public static boolean test1() {
        ...
        boolean result = tree.toInOrderString().equals("[ 1, 2, 3 ]");

        return result;
    }

    /**
     * This test method performs a left rotation and then checks if the tree is balanced
     * @return a boolean on whether the tree is balanced or not
     */
    ...
    /**
     * This test method performs a left-right rotation and then checks if the tree is balanced
     * @return a boolean on whether the tree is balanced or not
     */
    public static boolean test3() {
        ...
        // Rotate left (child = 1, parent = 2)
        tree.rotate(tree.root.down[0], tree.root);

        // Rotate right (child = 3, parent = 2)
        tree.rotate(tree.root.down[1], tree.root);
    ...
    // BELOW ARE STUFF REQUIRED FOR SORTEDCOLLECTIONINTERFACE
